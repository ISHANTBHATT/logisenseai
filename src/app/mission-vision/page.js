...
function TabsDemo() {
        ...
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-[#25ABBE] to-[#1A6DAF]">
          <div className="flex flex-col-reverse md:flex-row justify-between items-center w-full h-full">
            ...
            <div className="ml-6 ">
              ...
              <p className="text-gray-50 text-lg md:text-xl max-w-2xl text-center md:text-left">
                Our Vision To position Logisense.AI as a global hub for
                entrepreneurial transformation. We envision a world where
                startups evolve into future-ready enterprises that drive
                operational excellence, inspire collaboration, and redefine
                business standards across sectors.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="h-[80vh] md:h-[40rem] [perspective:1000px] relative b flex flex-col mx-auto w-full  items-start justify-start my-40">
      <Tabs tabs={tabs} />
    </div>
  );
}
